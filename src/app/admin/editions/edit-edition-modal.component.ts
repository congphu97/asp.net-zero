...
import { ComboboxItemDto, CommonLookupServiceProxy, UpdateEditionDto, EditionServiceProxy, GetEditionEditOutput } from '@shared/service-proxies/service-proxies';
...
export class EditEditionModalComponent extends AppComponentBase {
    ...
    constructor(
     ...
     GetData(editionId?: number):Promise<GetEditionEditOutput> {
    ...
    async show(editionId?: number) {
        this.active = true;
        
        let editionResult = await this.GetData(editionId)
